 ...
 */
function Como_Consult_get_max( $array ) {

	return Como_Consult_Globals::get_max( $array );
 ...
 */
function Como_Consult_get_svg( $svg ) {

	return Como_Consult_Globals::get_svg( $svg );
 ...
 */
function Como_Consult_get_template( $name ) {

	return Como_Consult_Globals::get_template( $name );

}

class Como_Consult_Globals {
	 ...
	 */
 	public static function get_template( $name ) {
		...
		$locations[] = "{$name}.php";
		$locations[] = "/como-consult/{$name}.php";
		 ...
		 */
		apply_filters( 'como-consult-template-paths', $locations );
...
// Custom Image Sizes
add_action( 'after_setup_theme', 'como_consult_img_sizes' );
function como_consult_img_sizes() {
	add_image_size( 'como-consult-logo', 150, 100, false);
	add_image_size( 'como-consult-circle', 200, 200, false); 
}