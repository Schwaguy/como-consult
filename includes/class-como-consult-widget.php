 ...
 */
class Como_Consult_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$name 					= esc_html__( 'Como Consult', 'como-consult' );
		$opts['classname'] 		= '';
		$opts['description'] 	= esc_html__( 'Display consult in a sidebar', 'como-consult' );
	...
	function widget( $args, $instance ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'partials/como-consult-display-widget.php' );
