 ...
 * @subpackage Como Consult/includes
 */

class Como_Consult_Sanitize {
	...
	public function clean() {
		 ...
		 */
		do_action( 'como_formpage_pre_sanitize', $sanitized );
		 ...
		 */
		do_action( 'como_formpage_post_sanitize', $sanitized );
	...
	public function set_type( $type ) {
		...
		if ( empty( $type ) ) {
			...
			$check = new WP_Error( 'forgot_type', __( 'Specify the data type to sanitize.', 'como-consult' ) );

		}

		if ( is_wp_error( $check ) ) {

			wp_die( $check->get_error_message(), __( 'Forgot data type', 'como-consult' ) );
