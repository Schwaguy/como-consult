...
<button type="button" class="btn btn-primary consult-button openModal" data-toggle="modal" data-bs-toggle="modal" data-target="#consultModal" data-bs-target="#consultModal" title="<?=$options['default-button-title']?>" aria-label="<?=$options['default-button-title']?>" role="button"><?=$options['default-button-title']?></button>
