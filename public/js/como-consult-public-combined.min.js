...
// Image Tools
"use strict";if(void 0===exports)var exports={};if(void 0===module)var module={};Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,a,r){return a&&e(t.prototype,a),r&&e(t,r),t}}();function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var hasBlobConstructor="undefined"!=typeof Blob&&function(){try{return Boolean(new Blob)}catch(e){return!1}}(),hasArrayBufferViewSupport=hasBlobConstructor&&"undefined"!=typeof Uint8Array&&function(){try{return 100===new Blob([new Uint8Array(100)]).size}catch(e){return!1}}(),hasToBlobSupport="undefined"!=typeof HTMLCanvasElement&&HTMLCanvasElement.prototype.toBlob,hasBlobSupport=hasToBlobSupport||"undefined"!=typeof Uint8Array&&"undefined"!=typeof ArrayBuffer&&"undefined"!=typeof atob,hasReaderSupport="undefined"!=typeof FileReader||"undefined"!=typeof URL,ImageTools=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"resize",value:function(t,a,r){if(!e.isSupported()||!t.type.match(/image.*/))return r(t,!1,"Sorry. This operation is not supported by your device."),!1;if(t.type.match(/image\/gif/))return r(t,!1,"Please choose a JPG or PNG image."),!1;if(!(t.size<=a)){var o=document.createElement("img");return o.onload=function(n){var i=Math.sqrt(t.size/a),s=Math.ceil(o.height/i),l=Math.ceil(o.width/i),u=document.createElement("canvas");u.width=l,u.height=s;var c=u.getContext("2d");c.imageSmoothingEnabled=!0,c.imageSmoothingQuality="high",EXIF.getData(o,function(){var a=EXIF.getTag(this,"Orientation");switch(Number(a)){case 1:break;case 2:c.translate(l,0),c.scale(-1,1);break;case 3:c.translate(l,s),c.rotate(1*Math.PI);break;case 4:c.translate(0,s),c.scale(1,-1);break;case 5:u.width=s,u.height=l,c.rotate(.5*Math.PI),c.scale(1,-1);break;case 6:u.width=s,u.height=l,c.rotate(.5*Math.PI),c.translate(0,-s);break;case 7:u.width=s,u.height=l,c.rotate(1.5*Math.PI),c.translate(-l,s),c.scale(1,-1);break;case 8:u.width=s,u.height=l,c.translate(0,l),c.rotate(1.5*Math.PI)}if(c.drawImage(o,0,0,l,s),hasToBlobSupport)u.toBlob(function(e){r(e,!0,"Resized.  No errors.")},t.type);else{var n=e._toBlob(u,t.type);r(n,!0,"Resized.  No errors.")}})},e._loadImage(o,t),!0}r(t,!0,"No need to resize.")}},{key:"_toBlob",value:function(e,t){var a=e.toDataURL(t).split(","),r=void 0;r=a[0].indexOf("base64")>=0?atob(a[1]):decodeURIComponent(a[1]);for(var o=new ArrayBuffer(r.length),n=new Uint8Array(o),i=0;i<r.length;i+=1)n[i]=r.charCodeAt(i);var s=a[0].split(":")[1].split(";")[0],l=null;if(hasBlobConstructor)l=new Blob([hasArrayBufferViewSupport?n:o],{type:s});else{var u=new BlobBuilder;u.append(o),l=u.getBlob(s)}return l}},{key:"_loadImage",value:function(e,t,a){if("undefined"==typeof URL){var r=new FileReader;r.onload=function(t){e.src=t.target.result,a&&a()},r.readAsDataURL(t)}else e.src=URL.createObjectURL(t),a&&a()}},{key:"isSupported",value:function(){return"undefined"!=typeof HTMLCanvasElement&&hasBlobSupport&&hasReaderSupport}}]),e}();exports.default=ImageTools,module.exports=exports.default;

// Como Consult Scripts
!function(e){"use strict";var o=e("#virtual-consult");e(".modal-trigger a").click(function(){return e("#consultModal").modal("show"),!1}),e("#processing").addClass("hide"),e(".img-upload").on("change",function(o){var t=e(this).parent(".img-upload-wrap").children(".img-upload-preview"),n=e(this).parent(".img-upload-wrap").children(".img-path"),s=(e(this).parents(".formpage"),o.target.files[0]),a=o.target.name,i=new FormData,l=window.location;l.protocol,l.host,l.pathname.split("/")[1];if(s.type.match("image.*")){e("#processing").removeClass("hide");ImageTools.resize(s,262144,function(o,l,r){if(l){i.append("file",o,s.name),i.append("fieldName",a);var c=new XMLHttpRequest;c.open("POST","/wp-content/plugins/como-consult/public/inc/imageUpload.php",!0),c.setRequestHeader("Access-Control-Allow-Origin","*"),c.setRequestHeader("Access-Control-Allow-Methods","POST"),c.send(i),c.onload=function(){var o=JSON.parse(c.response);if(200===c.status&&"ok"===o.status){var s=o.fileName,a=(o.fieldName,"/wp-content/uploads/client-consult-photos/"+s);t.attr("src",a),t.fadeIn(500),n.val(a),e("#processing").addClass("hide")}else e("#processing").addClass("hide"),alert(r)}}})}else alert("Please choose an image file of type PNG or JPG.")}),e(document).on("click tap",".img-upload-preview",function(){e(this).parent(".img-upload-wrap").children(".img-upload").click()}),e(".phone-field").mask("(999) 999-9999");var t=o.validate({ignore:".ignore",errorClass:"warning",onkeyup:!1,onfocusout:!1});function n(o,t=!1){var n=o.parents(".formpage"),s=n.next(".formpage").not(".noShow"),a=s.attr("id");e.when(n.addClass("hide-left")).done(function(){if(e("input","#"+a).removeClass("ignore"),!0===t){var o=s.height();e(".modal-body").css("height",o+150+"px"),s.css("height","auto").removeClass("hidden")}else s.css("height","auto").removeClass("hidden")})}function s(o,t){o[0].reset(),t&&(e(".modal-body .formpage").not(":first").addClass("hidden"),e(".modal-body .formpage:first").removeClass("hide-left"))}e(".modal-body .formpage:first").removeClass("hidden"),e("#consultModal").on("shown.bs.modal",function(){e(this).find(".modal-body").css({height:"auto","max-height":"100%"}),e("body").find(".cpcta-flyin").removeClass("slidOut"),e("body").find(".cpcta-flyin .cpcta-content-panel").css({display:"none"})}),e(".next-button").on("click",function(){t.form()&&n(e(this),!1)}),e("#consultModal .reset").on("click",function(){!0===confirm("WARNING: This will reset the consult form and you will need to start over.")&&(s(o,!0),e("#consultModal").modal("hide"))}),e("#consultModal .close-button").on("click",function(){s(o,!0),e("#consultModal").modal("hide")}),e("#virtual-consult").submit(function(t){t.preventDefault(),e("#processing").removeClass("hide");var a=e("#submitURL").val(),i=new FormData(this),l=e("#virtual-consult input[type=submit]");e(this).find("input[type=file]").each(function(){i.delete(e(this).attr("name"))}),e.ajax({type:"POST",url:a,data:i,dataType:"json",crossDomain:!1,async:!0,cache:!1,contentType:!1,processData:!1,timeout:1e4}).done(function(t){t.output?"messagesent"===t.output.response?e.when(e("#processing").addClass("hide")).done(function(){n(l,!0),s(o,!1)}):(e("#feedback").html("<p>"+t.output.feedback+"</p>"),setTimeout(function(){e("#processing").removeClass("hide")},3e3)):console.log("NO ACCOUNT")}).fail(function(e,o,t){console.log("ERROR");var n=JSON.parse(e.responseText);console.log(n.Message)})})}(jQuery);